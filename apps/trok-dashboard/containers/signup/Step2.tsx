...
import { notifyError, OnboardingAccountStep2, OnboardingDirectorInfo } from '@trok-app/shared-utils';
...
const Step2 = ({ prevStep, nextStep }) => {
	...
	return (
		<form
			...
			data-cy='onboarding-director-form'
		>
			...
			<Stack>
				<Group grow>
					<TextInput
						...
						data-cy='onboarding-director-firstname'
					/>
					<TextInput
						required
						label='Last name'
						{...form.getInputProps('lastname')}
						data-cy='onboarding-director-lastname'
					/>
				</Group>
				<Group grow>
					<TextInput
						...
						data-cy='onboarding-director-email'
					/>
					<DatePicker
						required
				...
				<Group grow>
					<TextInput
						...
						data-cy='onboarding-director-line1'
					/>
					<TextInput
						label='Address line 2'
						{...form.getInputProps('line2')}
						data-cy='onboarding-director-line2'
					/>
				</Group>
				<Group grow>
					<TextInput
						...
						data-cy='onboarding-director-city'
					/>
					<TextInput
						required
						label='Postal Code'
						{...form.getInputProps('postcode')}
						data-cy='onboarding-director-postcode'
					/>
				</Group>
				<Group grow>
					<TextInput
						...
						data-cy='onboarding-director-region'
					/>
